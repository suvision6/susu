#!/usr/bin/env python3
"""Create non-overwriting 3.1.5 review drafts from valid 3.1.3 inputs."""
...
SCRIPT_INTERFACE_REASON = "Explicit non-overwriting 3.1.3 to 3.1.5 draft migration."
ZERO_HASH = "0" * 64
...
def build_drafts(
    ...
    gate_one.update({
        ...
        "note": "3.1.3 to 3.1.5 migration requires renewed Gate 1",
    })
    ...
    report = {
        "migration": "director-shot-data/3.1.3 -> director-shot-data/3.1.5",
        "workspace_migration": "director-workspace/3.1.3 -> director-workspace/3.1.5",
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="非覆盖迁移 3.1.3 到 3.1.5 审阅草稿。")
