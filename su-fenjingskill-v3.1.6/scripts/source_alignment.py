...
def alignment_payload(workspace: Mapping[str, Any], shot_data: Mapping[str, Any]) -> Dict[str, Any]:
        ...
        formal_execution.append(
            {
                ...
                "timing_plan": copy.deepcopy(shot.get("timing_plan")),
    ...
    return {
        ...
        "format_brief": copy.deepcopy(shot_data.get("format_brief")),
...
def materialize_source_excerpts(
    ...
    """Return a formal 3.1.6 copy with canonical scene and shot excerpts."""
