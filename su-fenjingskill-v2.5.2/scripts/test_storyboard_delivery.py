...
def upgrade_draft_v240(draft: dict) -> dict:
    """Normalize legacy fixture prose into the director-and-DOP 2.5.2 contract."""
    draft["contract_version"] = "2.5.2"
    draft["source_skill_version"] = "2.5.2"
...
class StoryboardDeliveryTests(unittest.TestCase):
    ...
    def test_build_declares_contract_and_preserves_handoff_fields(self) -> None:
        ...
        self.assertEqual(built["contract_version"], "2.5.2")
        self.assertEqual(built["source_skill"], "su-fenjingskill")
        self.assertEqual(built["source_skill_version"], "2.5.2")
    ...
    def test_gate_2_digest_binds_integrity_revision(self) -> None:
        ...
        try:
            ...
            delivery.GATE_2_RULE_REVISION = "2.5.2-binding-integrity-r0"
