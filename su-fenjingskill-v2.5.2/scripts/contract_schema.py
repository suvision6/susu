#!/usr/bin/env python3
"""Machine-authoritative structural schema for shot-data/2.5.2.
...
def public_json_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "$id": "https://suvision6.github.io/susu/shot-data-2.5.2.schema.json",
        "title": "shot-data/2.5.2 public structure",
        "$comment": (
