#!/usr/bin/env python3
"""Regression tests for the shot-data/2.4.4 delivery contract."""
...
def upgrade_draft_v240(draft: dict) -> dict:
    """Normalize legacy fixture prose into the director-first 2.4.4 contract."""
    draft["contract_version"] = "2.4.4"
    draft["source_skill_version"] = "2.4.4"
...
class StoryboardDeliveryTests(unittest.TestCase):
    ...
    def test_build_declares_contract_and_preserves_handoff_fields(self) -> None:
        ...
        self.assertEqual(built["contract_version"], "2.4.4")
        self.assertEqual(built["source_skill"], "su-fenjingskill")
        self.assertEqual(built["source_skill_version"], "2.4.4")
    ...
    def test_actual_ep15_v201_is_rejected_for_known_failure_signatures(self) -> None:
        ...
        data["contract_version"] = "2.4.4"
        data["source_skill_version"] = "2.4.4"
