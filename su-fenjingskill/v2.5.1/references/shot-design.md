...
```text
【全景｜微俯视｜人物与坡地形成纵深｜摇臂下降】
【中景｜平视｜双人关系构图｜缓慢推进】
【中景→特写｜微仰视｜人物从环境中被逐步隔离｜缓慢推进】
【全景｜平视｜人物沿街道纵向移动｜斯坦尼康跟随】
【近景｜平视｜单人面孔偏离中心｜固定】
```
...
终稿 camera 必须兑现规划的景别、角度、机位、构图、主体和运镜计划。第五列不得显示内部轴线 ID 或机器状态，也不要求逐字包含 camera 字段。
...
正文只读取唯一 `execution_text`。旧版 `execution_passages[]` 只能作为迁移材料，不是 2.5.1 权威正文。正式新建正文不再拆分【镜头调度】【人物表演与声音】【镜头结束】三段，而是写成一个连续的【画面内容】段落，顺序为：
