...
This script is the image-generation stage of the su-image9 v2.2.0 pipeline.
It reads panel_plan.json and final_image_prompts.compiled.md, extracts each
panel prompt, and delegates to a configurable image backend. In v2.2.0 the
...
def get_backend() -> str:
    ...
    # In v2.2.0 only the stub backend is provided. Future backends can be
