...
class StoryboardDeliveryTests(unittest.TestCase):
    ...
    def test_contract_identity_is_3_1_3(self) -> None:
        self.assertEqual(self.example["contract_version"], "3.1.3")
        self.assertEqual(self.example["source_skill_version"], "3.1.3")
        ...
        self.assertEqual(schema["title"], "director-shot-data/3.1.3")
        self.assertEqual(schema["properties"]["contract_version"]["const"], "3.1.3")
        self.assertEqual(schema["properties"]["source_skill_version"]["const"], "3.1.3")
