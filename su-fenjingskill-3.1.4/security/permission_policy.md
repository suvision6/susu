...
- `migrate_contract_3_1_0_to_3_1_2.py`, `migrate_contract_3_1_2_to_3_1_3.py` and `migrate_contract_3_1_3_to_3_1_4.py` each write only three draft files inside an explicit empty output directory.

The scripts do not access the network, spawn subprocesses, install packages, overwrite source material or choose a broad recursive destination. Temporary staging trees created by `build-all` are removed on failure. Approval owner: suvision; review date: 2026-09-01; expiry: 2027-09-01.
