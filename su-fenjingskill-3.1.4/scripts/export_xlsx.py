#!/usr/bin/env python3
"""Deterministic human-facing XLSX renderer for director-shot-data/3.1.4.
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="将通过 combined gate 的 director-shot-data/3.1.4 导出为 XLSX。")
    parser.add_argument("--input", type=Path, required=True, help="输入 JSON 文件。")
    parser.add_argument("--workspace", type=Path, required=True, help="director-workspace/3.1.4。")
