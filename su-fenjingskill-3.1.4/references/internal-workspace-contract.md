# Internal Workspace Contract｜director-workspace/3.1.4

`director-workspace/3.1.4` 是来源、Gate 0、导演工作和正式 readiness 的内部事实载体，不是第五个正式交付文件。机器结构唯一权威是 [director-workspace.schema.json](../schemas/director-workspace.schema.json)。
