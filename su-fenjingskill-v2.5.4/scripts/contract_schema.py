...
DIALOGUE_REQUIRED_KEYS = {"fact_id", "speaker", "text", "shot_delivery"}
...
def public_json_schema() -> dict[str, Any]:
    ...
    fact["allOf"] = [
        {
            ...
            "then": {"required": ["speaker", "script_voice_type"]},
        }
    ]
    beat = _closed_object(
        {
    ...
    long_take_design = _closed_object(
        ...
        {"reason", "supports", "protected_event_ids"},
    )
    ...
    dialogue = _closed_object(
        ...
        {"fact_id", "speaker", "text", "shot_delivery"},
    )
